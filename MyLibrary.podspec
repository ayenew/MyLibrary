...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/aasmare/MyLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'aasmare' => 'ayeberel@gmail.com' }
  s.source           = { :git => 'https://github.com/aasmare/MyLibrary.git', :tag => s.version.to_s }
